...
export const handler = async (event) => {
  ...
  const dbConfig = {
   ...
   try {
    ...
    // Your SQL query
    const query = 'SELECT user_id, first_name, last_name, ensemble.ensemble_id, ensemble_name, branch.branch_id, branch_name, image FROM users INNER JOIN ensemble ON ensemble.ensemble_id = users.ensemble_id INNER JOIN branch ON ensemble.branch_id = branch.branch_id';
